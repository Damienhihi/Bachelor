...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{kapitel/anhang/images/Angebotspositionen.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{kapitel/anhang/images/Zusatzfeld1.png}
    \caption{Tool: Zusätzliches Feld (oberer Bereich)}
    \label{fig:ZusätzlichesFeld1}
\end{figure}  

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{kapitel/anhang/images/Zusatzfeld2.png}
    \caption{Tool: Zusätzliches Feld (unterer Bereich)}
    \label{fig:ZusätzlichesFeld2}
\end{figure}  
