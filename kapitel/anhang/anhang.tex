...
\textbf{Identifikation eines geeigneten Use Cases für einen KI-Agenten in Dynamics 365 for Finance and Supply Chain Management}

\vspace{0.5em}

\textbf{Einstieg}

Ich möchte gemeinsam mit dir herausfinden, welcher Use Case sich in Dynamics 365 for Finance and Supply Chain Management besonders gut für den Einsatz eines Copilot-Agenten eignet.
...
\begin{itemize}
    \item Welche Prozesse oder Aufgaben in D365 FnSCM empfindest du als besonders zeitintensiv, fehleranfällig oder umständlich?
\end{itemize}
...
\begin{itemize}
    \item Wo siehst du grundsätzlich Potenzial für KI-Unterstützung durch einen Copilot-Agenten in D365 FnSCM?
...
\textbf{Einleitung}\newline
Ich möchte gemeinsam mit dir herausfinden, welcher Use Case sich in D365 FnSCM besonders gut für den Einsatz eines Copilot-Agenten eignet.
Das Gespräch dauert nur wenige Minuten und dient der Identifikation eines sinnvollen und relevanten Anwendungsszenarios.

\textbf{Welche Prozesse oder Aufgaben in D365 FnSCM empfindest du als besonders zeitintensiv, fehleranfällig oder umständlich?}\newline
...
\textbf{Wo siehst du grundsätzlich Potenzial für KI-Unterstützung durch einen Copilot-Agenten in D365 FnSCM?}\newline
...
Ja die Fehleranfälligkeit kann zu einem Problem werden. Es ist wichtig, dass wenig Fehler auftreten und wenn dies der Fall ist diese einfach zu identifizieren und nachzuvollziehen sind. Ist dies nicht der Fall, schwindet die Userakzeptanz und der Agent wird nicht genutzt.

\textbf{Hast du sonst noch irgendwelche Anmerkungen?}\newline
Bei allen ERP Themen muss immer vom „unfähigsten“ User ausgegangen werden. Dies sind im Projekt meist die User an denen solche Umsetzungen scheitern können.
...
Für meine Bachelorarbeit entwickle ich einen Copilot-Agenten, der Anwender beim Anlegen eines neuen Angebots in D365 FnSCM unterstützen soll.
...
\begin{itemize}
    \item Welche Rolle hast du im Kontext von D365 FnSCM, und wie vertraut bist du mit der Angebotserstellung?
\end{itemize}
...
\begin{itemize}
    \item Wie läuft das Anlegen eines neuen Angebots in D365 FnSCM aktuell typischerweise ab?
...
\begin{itemize}
    \item Wie sollte der Agent in D365 FnSCM verfügbar sein: als eigenes Fenster, als integriertes Panel im Formular oder in einer anderen Form?
...
\label{anhang:i2}
\textbf{Börgel, Damien}\newline
Genau, für meine Bachelorarbeit entwickle ich einen Copilot Agenten, der dem Anwender dann beim Anlegen von Angeboten in D365 for Finance and Supply Chain Management helfen soll.
...
Gut, fangen wir erst mit der ersten Frage an: Welche Rolle hast du mit Kontext mit D. 365 FnSCM und wie vertraut bist du mit der Angebotserstellung?
...
\textbf{Börgel, Damien}\newline
Super.
Ja, dann wäre direkt die erste Frage zum Thema des Angebots wieder aktuell, also mit mit D. 365 FnSCM selber, wie das so typischerweise abläuft, wenn man ein Angebot da drin erstellt.
...
Das
Ja, ich wüsste jetzt nicht, was noch für Varianten gibt, ah, vielleicht doch eine eine Sache fällt mir noch auf, wenn wir manuelle Angebote eingeben und wir haben oder Mengen Vorgaben, die pro Artikelnummer und dann geht ja immer so 'n Abfragekontext auf der bestätigt werden muss, ob wir das übernehmen möchten oder nicht. Das kann auch noch mal 'ne Aufgabe sein, die dann so 'n Agent übernehmen muss oder ja, die Berechtigung dazu haben muss, diese Bestätigung auszufüllen, wenn ich das denn möchte.
...
\textbf{Welche Rolle hast du im Kontext von D365 FnSCM, und wie vertraut bist du mit der Angebotserstellung?}\newline
...
\textbf{Wie läuft das Anlegen eines neuen Angebots in D365 FnSCM aktuell typischerweise ab?}\newline
Als Antwort auf diese Frage wurde eine BPMN-Modellierung des Angebotsprozesses bereitgestellt. Aufgrund des Umfangs wurde diese als separates Zusatzdokument digital eingereicht.
...
Die wichtigsten Informationen im Angebot sind die Artikel und die Preise. Die typischen Probleme entstehen bei der Artikelsuche. Diese ist architekturbedingt recht träge und nimmt bei Fehlangaben oder wenn nicht alle benötigten Informationen vorliegen viel Zeit in Anspruch.
...
Meine Vorstellung wäre, dass der Agent Angebotsköpfe erstellen kann. Er sollte auf Basis der Userinteraktion differenzieren können um welchen Angebotstyp es sich handelt. Bei den Angebotspositionen sollte der Agent die Artikelsuche unterstützen und bestenfalls Preishistorien aufzeigen können. Dadurch würde viel Aufwand erspart werden können. Bei der Preishistorie meine ich zu welchem Preis der Artikel in der Vergangenheit angeboten wurde oder zu welchem Preis andere Debitorendiesen bezogen haben. 

\textbf{Auf welche Daten sollte der Agent zugreifen können, um sinnvolle Unterstützung zu bieten?}\newline
Auf Stammdaten aus D365 wie die Debitorenstammdaten, Artikelstammdaten inkl. Wiederbeschaffungszeiten. Er sollte auf Lagerbestände zugriff haben und auf Bewegungsdaten wie alle Angebote und ggf. alle Aufträge.
...
\newpage
\subsection{Kategoriesystem zur Auswertung}
\label{anhang:Kategorisierung}
\footnotesize
\begin{longtable}{|p{1.9cm}|p{1.9cm}|p{3cm}|p{3cm}|p{3cm}|}
\caption{Kategoriesystem}\label{tab:kategorien}\\
\hline
\textbf{Kategorien} & \textbf{Unterkategorien} & \textbf{Interview 1} & \textbf{Interview 2} & \textbf{Interview 3} \\
\hline
\endfirsthead
...
K1 Use Case & 1.1 Use Case & Angebotsanlage mit Artikelsuche &  &  \\
\hline
 & 1.2 Aufbau: &  & Genau beschrieben wie es im BPMN dargestellt ist -> viele Felder die an unterschiedlichen Stellen im ERP hinterlegt sind, wird auch später nochmal erwähnt & Siehe BPMN aus Interview 3 \\
\hline
 & 1.3 spezifische Anforderungen/Erwartungen &  & wichtigste Felder sollen angelegt werden. Unterstützung bei Suche von Artikeln. Beachten von Mengenvorgaben. Abänderungen, wenn zu Beginn falsche Angaben gemacht wurden & Soll Angebotsköpfe erstellen und bei der Hinzufügung von Positionen unterstützen. Identifikation von Artikeln und ggf. Hinzufügen einer Preishistorie \\
\hline

K2 Probleme & 2.1 Zeitintensität & Anlage großer Angebote und Aufträge ist zeitintensiv. Bei Projekten über mehrere Mandanten zeitintensiv. &  & Erfassen von Feldern, welche nicht vom System als notwendig markiert sind, aber vom Kunden gewünscht sind. \\
\hline
 & 2.2 Artikelsuche & Artikelsuche ist immer ein Thema und erschwert die Angebotsanlage durch aufwendiges Identifizieren des richtigen Artikels soll auf jeden Fall unterstützt werden & Artikelnummern zu hinterlegen, da eine ganze "Batterie" an Datensätzen kommt bei der Suche & Suche reagiert träge und dauert bei Fehlangaben oder wenn nicht alle benötigten Informationen vorliegen besonders lange \\
\hline
 & 2.3 Manueller Aufwand & Fehlende Kopierfunktionen führen zu manuellem Mehraufwand &  &  \\
\hline
 & 2.4 Fehlerhafte Dokumentenanlage & User legen Angebote und Aufträge häufig falsch an und Fehler führen zu notwendiger Fehlerbehebung zu späterem Zeitpunkt, was zeitintensiv ist &  &  \\
\hline

K3 User & 3.1 Zielgruppe & Generell Nutzer, aber insbesondere auch neue Nutzer benötigen Unterstützung bei der Dokumentanlage da sie dazu tendieren Falsche Dokumente anzulegen & Vertriebsmitarbeiter aber auch die Kunden selber &  \\
\hline
 & 3.2 Akzeptanz & Fehlerhafte oder nicht nachvollziehbare Ergebnisse senken die Akzeptanz. Es muss vom DAU ausgegangen werden, also einfache Nutzung &  & zwingend notwendig für Akzeptanz: Agent soll Rückfragen stellen, wenn Informationen fehlen \\
\hline
 & 3.3 Verfügbarkeit &  & Unterstützender Chat während eines Telefonates mit dem Kunden, aber auch direktes Chatten vom Kunden mit dem Chatbot, um Angebote anzulegen & Chat-Interface als Ausbaustufe, die Verarbeitung externer Eingaben \\
\hline

K4 Erwartungen & 4.1 Fehlerhandling & wichtig, dass wenig Fehler auftreten und wenn dies der Fall ist diese einfach zu identifizieren und nachzuvollziehen sind. Ist dies nicht der Fall, schwindet Userakzeptanz und der Agent wird nicht genutzt. &  & Wenn Fehler auftreten, müssen diese zumindest leicht erkennbar und nachvollziehbar sein. \\
\hline

 & 4.2 Artikelsuche & Die Unterstützung der Angebotsanlage und damit verbunden die Artikelsuche. & Vorbelegen von Artikel, durch entsprechende Inhalte, die bekannt sind. & Bei den Angebotspositionen sollte der Agent die Artikelsuche unterstützen \\
\hline
 & 4.3 Preishistorie &  &  & Preishistorien aufzeigen. Dadurch würde viel Aufwand erspart werden können -> zu welchem Preis der Artikel in der Vergangenheit angeboten wurde oder zu welchem Preis andere Debitoren diesen bezogen haben. \\
\hline
 & 4.4 Mengen-vorgaben &  & Angebote eingeben und wir haben oder Mengen Vorgaben, die pro Artikelnummer und dann geht ja immer so 'n Abfragekontext auf der bestätigt werden muss, ob wir das übernehmen möchten oder nicht. &  \\
\hline

K5 Datenzugriff &  &  & Stammdaten auf D365 FnO, Felder wie Artikelnummer, Referenznummer, abweichende Lieferadresse und Telefonnummer, & Auf Stammdaten von D365 FnO, wie Debitoren, Artikel, Lagerbestand, Angebote \\
\hline

% --- Trennlinie vor neuer Hauptkategorie ---
K6 Risiken &  &  & Fehler beim Erstellen von Datensätzen & Darf keine groben Fehler machen, sonst wird er nicht genutzt. Wenn Fehler entstehen, müssen sie zumindest leicht erkennbar sein \\
\hline

% --- Trennlinie vor neuer Hauptkategorie ---
K7 Scope-Abgrenzung bzw. Erweiterungs-möglichkeiten &  &  & Benachrichtigung wenn Angebot vor Ablauf ist, Angebot wandeln, stornieren auch. Telefonbot. Neukunde bestandskunde abgrenzen. Zum schluss noch erwähnt sich erstmal mit dem leichtesten Fall zu beschäftigen & Funktionalität nicht zu umfangreich, erstmal vorhandene Funktionen optimal erfüllen. Qualität vor Quantität. \\
\hline
...
\section{Instructions des KI-Agenten}
\label{anhang:Instructions}
\textbf{Rolle}

Der KI-Agent agiert als Assistent innerhalb des ERP-Systems \textit{Microsoft Dynamics 365 for Finance and Supply Chain Management}.  
Seine Aufgabe besteht darin, den Nutzer bei der vollständigen Anlage eines Verkaufsangebots zu unterstützen.

Hierfür stehen dem Agenten zwei Systemtools zur Verfügung:

\begin{itemize}
    \item \textbf{Angebotskopf erstellen}
    \item \textbf{Angebotspositionen erstellen}
\end{itemize}

\textbf{Ziel}

Ziel des Agenten ist es, alle für ein Verkaufsangebot erforderlichen Informationen strukturiert zu erfassen, deren Vollständigkeit zu prüfen, relevante Stammdaten zu validieren und das Angebot korrekt im System anzulegen.

Dabei gelten folgende Grundprinzipien:

\begin{itemize}
    \item Zuerst wird der Angebotskopf erstellt.
    \item Anschließend werden eine oder mehrere Angebotspositionen angelegt.
    \item Pflichtfelder werden konsequent geprüft.
    \item Debitoren- und Artikeldaten werden über vorhandene Wissensquellen validiert.
    \item Nach Abschluss erfolgt eine klare Rückmeldung über Erfolg oder Fehler.
\end{itemize}

Die gesamte Kommunikation erfolgt ausschließlich auf Deutsch.

\textbf{Speicherregeln}

Alle vom Nutzer gemachten Eingaben sind über das gesamte Gespräch hinweg zu speichern.  
Bereits genannte Informationen dürfen nicht erneut abgefragt werden.

\textbf{Vorgehensmodell}

\textbf{1. Initiale Datenerfassung}

Der Agent startet den Prozess immer mit der Aufforderung an den Nutzer, alle relevanten Daten für das Angebot einzugeben.

\begin{itemize}
    \item Es dürfen keine konkreten Felder genannt oder aufgelistet werden.
    \item Alle Eingaben sind strukturiert zu speichern.
\end{itemize}

\textbf{2. Prüfung der Pflichtfelder}

Der Agent besitzt Zugriff auf eine Pflichtfeldliste.

Pflichtfelder Angebotskopf:
\begin{itemize}
    \item Debitorennummer (Entität: \texttt{REQUESTINGCUSTOMERACCOUNTNUMBER})
\end{itemize}

Vorgehen:

\begin{itemize}
    \item Prüfung, ob alle Pflichtfelder vollständig vorliegen.
    \item Es dürfen keine Beispiele für mögliche Felder genannt werden.
    \item Fehlende Felder sind einzeln und explizit abzufragen.
    \item Die Prüfung wird wiederholt, bis alle Pflichtfelder vollständig vorhanden sind.
\end{itemize}

\textbf{3. Debitorenvalidierung}

Zur Validierung wird die Wissensquelle \textit{Debitoren} verwendet.

\begin{itemize}
    \item Wird ein Debitorenname eingegeben, erfolgt eine Suche nach der passenden Debitorennummer.
    \item Abweichungen durch unvollständige Namen oder Rechtschreibfehler sind zu berücksichtigen.
\end{itemize}

Entscheidungslogik:

\begin{itemize}
    \item \textbf{Eindeutiger Treffer:} Debitorennummer übernehmen.
    \item \textbf{Mehrere Treffer:} Nutzer zur Präzisierung auffordern.
    \item \textbf{Kein Treffer:} Nutzer um korrigierte oder genauere Angaben bitten.
\end{itemize}

\textbf{4. Anlage des Angebotskopfs}

Vor dem Tool-Aufruf gilt:

\begin{itemize}
    \item Alle erfassten Felder sind vollständig zu wiederholen.
    \item Der Nutzer muss explizit bestätigen, dass die Angaben korrekt sind.
    \item Wurde ein Feld verändert, ist die vollständige Wiederholung erneut durchzuführen.
\end{itemize}

Erst nach der Bestätigung erfolgt der Aufruf des Tools:

\begin{itemize}
    \item \textbf{Angebotskopf erstellen}
\end{itemize}

Dabei werden alle validierten Kopfdaten inklusive der Debitorennummer übergeben.

Rückgabewert:
\begin{itemize}
    \item \texttt{SalesQuotationNumber}
\end{itemize}

Diese Nummer ist zu speichern und für alle Angebotspositionen zu verwenden.

Nutzerfeedback:
\begin{itemize}
    \item Erfolg: Anzeige der Angebotsnummer.
    \item Fehler: Klare Beschreibung und Aufforderung zur Korrektur.
\end{itemize}

\textbf{5. Datenerfassung der Angebotspositionen}

Nach erfolgreicher Erstellung des Angebotskopfs fordert der Agent den Nutzer zur Eingabe der Positionsdaten auf.

\begin{itemize}
    \item Auch hier dürfen keine konkreten Felder vorgegeben werden.
    \item Eine Position umfasst alle relevanten Positionsdaten wie Artikel, Menge, Preis usw.
\end{itemize}

\textbf{6. Artikelvalidierung}

Zur Validierung wird die Wissensquelle \textit{Artikel} verwendet.

\begin{itemize}
    \item Suche anhand von Artikelnamen oder ähnlichen Eingaben.
    \item Rechtschreibfehler und ähnliche Begriffe sind zu berücksichtigen.
    \item Führende Nullen in der Artikelnummer dürfen nicht entfernt werden.
    \item Artikelnummern sind als String zu speichern.
\end{itemize}

Entscheidungslogik:

\begin{itemize}
    \item \textbf{Eindeutiger Treffer:}
    \begin{itemize}
        \item ItemNumber übernehmen
        \item Artikelnummer dem Nutzer zurückmelden
    \end{itemize}

    \item \textbf{Mehrere Treffer:}
    \begin{itemize}
        \item Liste mit Artikelnummer und Artikelnamen anzeigen
        \item Nutzer zur Auswahl auffordern
        \item Gewählte ItemNumber übernehmen
    \end{itemize}

    \item \textbf{Kein Treffer:}
    \begin{itemize}
        \item Nutzer informieren
        \item Um genauere Angaben bitten
    \end{itemize}
\end{itemize}

\textbf{7. Prüfung der Pflichtfelder für Angebotspositionen}

Alle eingegebenen Positionsdaten sind anhand der Pflichtfeldliste zu prüfen.

\begin{itemize}
    \item Fehlende Felder sind explizit abzufragen.
    \item Anschließend sind alle erfassten Felder vollständig zu wiederholen.
    \item Der Nutzer ist zu fragen, ob weitere Daten ergänzt werden sollen.
    \item Erst nach expliziter Bestätigung darf das Tool aufgerufen werden.
\end{itemize}

\textbf{8. Tool-Aufruf Angebotspositionen erstellen}

Für jede Position wird das Tool einzeln ausgeführt:
...
\begin{itemize}
    \item Für alle Positionen wird dieselbe \texttt{SalesQuotationNumber} verwendet.
\end{itemize}

Rückmeldung:
\begin{itemize}
    \item Erfolg: Bestätigung der Position.
    \item Fehler: Klare Fehlerbeschreibung und Möglichkeit zur Nachkorrektur.
\end{itemize}

\textbf{9. Weitere Positionen}

Nach jeder erfolgreich angelegten Position fragt der Agent:

\begin{itemize}
    \item Ob eine weitere Position hinzugefügt werden soll.
\end{itemize}

\begin{itemize}
    \item Bei \textbf{Ja}: Schritte 5 bis 8 erneut durchführen.
    \item Bei \textbf{Nein}: Abschluss durchführen.
\end{itemize}

\textbf{10. Abschluss}

Bei erfolgreicher Erstellung aller Positionen erfolgt folgende Abschlussmeldung:

\begin{quote}
    \textit{„Das Angebot wurde vollständig erstellt. Angebotsnummer: <Nummer>. Alle Positionen wurden erfolgreich angelegt.“}
\end{quote}

Bei Fehlern:

\begin{itemize}
    \item Klare Benennung des Problems
    \item Verständliche Übersetzung technischer Fehlermeldungen
    \item Konkrete Hinweise zur Korrektur
\end{itemize}

\textbf{Sprachrichtlinien}

\begin{itemize}
    \item Kommunikation ausschließlich auf Deutsch
    \item Sachlich, strukturiert und höflich formulieren
    \item Keine Annahmen bei fehlenden Daten
    \item Fehlermeldungen zusätzlich in verständlicher Sprache erklären
    \item Zusammenfassungen gezielt zur Klarheit einsetzen
\end{itemize}
...
\subsection{Beispielchat}
\label{anhang:beispielchat}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{kapitel/anhang/images/CopilotChat1.pdf}
    \caption{Beispielchat (1/2)}
