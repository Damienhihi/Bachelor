...
\subsection{Kategoriesierung der Interviewantworten}
\label{anhang:Kategoriesierung}

\begin{longtable}{l l X X X}
\caption{Kategorien und Unterkategorien aus den Interviews}\label{tab:kategorien-ba}\\
\toprule
...
\bottomrule
\endlastfoot
K1 Use Case & 4.1 Use Case & Angebotsanlage mit Artikelsuche &  &  \\
 & 4.2 Aufbau: &  & Genau beschrieben wie es im BPMN dargestellt ist -> viele Felder die an unterschiedlichen Stellen im ERP hinterlegt sind, wird auch später nochmal erwähnt & Siehe BPMN aus Interview 3 \\
 & 4.4 spezifische Anforderungen/Erwartungen &  & wichtigste Felder sollen Angelegt werden. Unterstützung bei suche von Artikeln. Beachten von Mengenvorgaben. Abänderungen wenn zu beginn falsche angaben gemacht wurden & Soll Angebotsköpfe erstellen und bei der hinzufügung von Positionen unterstützen. Identifikation von Artikel und ggf. hinzugeben einer Preishistorie \\
K2 Probleme & 1.1 Zeitintensität & Anlage großer Angebote und Aufträge ist zeitintensiv. Bei Projekten über mehrere Mandanten Zeitintensiv. &  & Erfassen von Feldern, welche nicht vom System als notwendig makiert sind, aber vom Kunden gewünscht sind. \\
 & 1.2 Artikelsuche & Artikelsuche ist immer ein Thema und erschwert die Angebotsanlage durch aufwendiges Identifizieren des richtigen Artikels soll auf jeden Fall unterstützt werden & Artikelnummern zu hinterlegen, da eine ganze "Batterie" an Datensätzen kommt bei der Suche & Suche reagiert träge und dauert bei Fehlangaben oder wenn nicht alle benötigten Informationen vorliegen besonders lange \\
 & 1.3 Manueller Aufwand & Fehlende Kopierfunktionen führen zu manuellem Mehraufwand &  &  \\
 & 2.1 Fehlerhafte Dokumenten-anlage & User legen Angebote und Aufträge häufig falsch an und Fehler führen zu notwendiger Fehlerbehebung zu späterem Zeitpunkt, was Zeitintensiv ist &  &  \\
K3 User & 3.1 Zielgruppe & Generell Nutzer, aber insbesondere auch neue Nutzer benötigen Unterstützung bei der Dokumentanlage da sie dazu tendieren Falsche Dokumente anzulegen & Vertriebsmitarbeiter aber auch die Kunden selber &  \\
 & 3.2 Akzeptanz & Fehlerhafte oder nicht nachvollziehbare Ergebnisse senken die Akzeptanz Muss vom DAU ausgegangen werden, also simple Nutzung &  & zwingend notwendigfür Akzeptanz: Agent soll Rückfragen stellen, wenn Informationen fehlen \\
 & 3.3 Verfügbarkeit &  & Unterstützender Chat während eines Telefonates mit dem Kunden aber auch direktes Chatten vom Kunden mit dem Chatbot um Angebote anzulegen & Chat interface als ausbaustufe die Verarbeitung externer Eingeben \\
