...
In Kapitel~5 wird der \ac{DSR}-Ansatz angewendet und eine Problem- und Anforderungsanalyse durchgeführt. Hierzu werden die durchgeführten Experteninterviews ausgewertet, um zunächst bestehende Probleme zu identifizieren und darauf aufbauend Anforderungen, Ziele sowie mögliche Effizienzpotenziale des \ac{KI}-Agenten in \ac{D365FnSCM} abzuleiten.
...
Daraufhin werden in Kapitel~8 die zentralen Ergebnisse der Arbeit zusammengefasst und die Limitationen diskutiert. Kapitel~9 schließt die Arbeit mit der Beantwortung der Forschungsfragen sowie einem Ausblick auf mögliche zukünftige Forschungsfelder ab.
